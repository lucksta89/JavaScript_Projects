...
function Input_Decimal(dot){
    //ensures that accidental clicking of the dec point
    //doesn't cause bugs in your operation
    if (Calculator.Wait_Second_Operand === true) return;
    if (!Calculator.Display_Value.includes(dot)){
        //we are saying that if the display value does not conation a dec point
        //we want to add one then 
...
function Handle_Operator(Next_Operator){
    ...
    //checks if an operator already exists and if Wait_SecondOperand is true
